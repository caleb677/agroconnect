...
import {
  ...
  MOCK_ORDERS_BUYER, MOCK_ORDERS_FARMER, MOCK_ORDERS_AGROVET, PRIVATE_THREADS,
  TUTORIALS_DATA, MOCK_SHIPMENTS, MOCK_TRANSPORT, MOCK_USERS, MURANGA_SUBCOUNTIES,
  MARKET_PRICES, TRACEABILITY_BATCHES, WEATHER_DATA, ACTIVITY_TYPES,
  DIARY_ACTIVITIES, MOCK_AUTH_SERVER
  ...
  return (
    <LangProvider>
      <div style={{ display: "flex", minHeight: "100vh", fontFamily: "'Segoe UI', system-ui, sans-serif", background: darkMode ? DARK.bg : "#f8f8f6", color: darkMode ? DARK.text : C.dark }}>
        {!isOnline && (
          <div style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 9999, background: "#92400E", color: "#fff", textAlign: "center", padding: "8px", fontSize: 13, fontWeight: 600 }}>
