...
// Reusable eye toggle button for password fields
// 👁️ = password currently VISIBLE (text)   👁️‍🗨️ = password currently HIDDEN (dots)
function EyeToggle({ visible, onToggle, top = "50%" }) {
  return (
    <button
      type="button"
      onClick={onToggle}
      style={{
        position: "absolute", right: 12, top, transform: "translateY(-50%)",
                  ...
                  {f.type === "select" ? (
                    ...
                    <div style={{ position: "relative" }}>
                      <input
                        ...
                        style={{ ...inputStyle(focusField === f.key), paddingRight: 45 }}
                        onFocus={() => setFocusField(f.key)}
                        onBlur={() => setFocusField("")}
                      />
                    </div>
          ...
          <div style={{ marginBottom: 6 }}>
            ...
            <div style={{ position: "relative" }}>
              <input
                ...
                style={{ ...inputStyle(focusField === "pw"), paddingRight: 45 }}
            ...
            {resetStep === 3 && (
              <div>
                ...
                <div style={{ position: "relative", marginBottom: 10 }}>
                  <input
                    value={resetNewPw}
                    onChange={e => { setResetNewPw(e.target.value); setError(""); }}
                    type={showResetPw ? "text" : "password"}
                    placeholder="Min 8 characters"
                    style={{ ...inputStyle(focusField === "np"), paddingRight: 45 }}
                    onFocus={() => setFocusField("np")}
                    onBlur={() => setFocusField("")}
                  />
                  <EyeToggle visible={showResetPw} onToggle={() => setShowResetPw(!showResetPw)} />
                </div>
                {resetNewPw.length > 0 && (() => {
                ...
                <div style={{ position: "relative", marginBottom: 16 }}>
                  <input
                    ...
                    onChange={e => { setResetConfirmPw(e.target.value); setError(""); }}
                    type={showConfirmPw ? "text" : "password"}
                    placeholder="Re-enter password"
                    onKeyDown={e => e.key === "Enter" && handleSetNewPassword()}
                    style={{ ...inputStyle(focusField === "cp"), paddingRight: 45 }}
                    onFocus={() => setFocusField("cp")}
                    onBlur={() => setFocusField("")}
                  />
                  <EyeToggle visible={showConfirmPw} onToggle={() => setShowConfirmPw(!showConfirmPw)} />
                </div>
